...
{
    public class RegistroActualizacionController : ControllerBase
    {
        public readonly IRegistroActualizacionServices _registroActualizacionServices;

        public RegistroActualizacionController(IRegistroActualizacionServices registroActualizacionServices)
        {
